  ...
  async function addMember() {
    ...
    try {
      const res = await fetch('/api/members', {
        ...
        body: JSON.stringify({ name, relation: newRelation.trim() || null, consent }),
      })
  ...
  return (
    <div className="relative">
      <button onClick={() => setOpen(o => !o)}
        className="flex items-center gap-1.5 px-3.5 h-[52px] rounded-full bg-yc-neutral100 active:bg-yc-neutral200 text-sm font-semibold text-yc-neutral700">
